...
<head>
    ...
    <style>
        body {
            background-image: url('../templates/blackgb.jpg');
        ...
        .section {
            background-image: url('../templates/blackbg.jpg');
            background-position: center;
            background-repeat: no-repeat;
            background-attachment: fixed;
            background-size: cover;
...
<body>
    ...
    <div class="scroll-indicator" id="scrollIndicator"><i class='fas fa-chevron-down' style='font-size:2.5vw;color:rgb(221, 83, 49)'></i></div>
        <div class="about-us" id="aboutUs1">
            ...
            <div class="text">
                <h3>Siti Hasmah Digital Library</h3>
    ...
    <div class="section">
        <div class="about-us" id="aboutUs2">
            <div class="text">
                <h2>Opening Hours during Breaks & Exam Weeks <h2><br>
              Trimester Break:<br>
              Weekdays, 9am – 5pm Closed during weekends<br>
              Examination Week:<br>
              Weekdays, 9am – 12am<br>
              Weekends, 9am – 5pm<br>
              Closed during Public Holiday</h2><br>
